...
import Otp from '../components/Otp'; // Import the OTP component
...
const OrderConfirmation = () => {
  ...
  const [isOtpSent, setIsOtpSent] = useState(false); // State to manage OTP sent status
  ...
  const handleOrderConfirm = () => {
    // Once the order is confirmed, trigger the OTP process
    setIsOtpSent(true);
  };
  ...
  return (
    <div className="confirm-order-page">
      ...
      {isOtpSent && <Otp />} {/* Render OTP component when order is confirmed */}
    </div>
  );
};
