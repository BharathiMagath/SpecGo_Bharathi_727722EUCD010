...
const ReadingglassProduct = () => {
  ...
  useEffect(() => {
    // Fetch products
    axios
      .get('http://localhost:8080/getReadingproductmen') // Adjust the URL as needed
      .then((response) => {
...
export default ReadingglassProduct;